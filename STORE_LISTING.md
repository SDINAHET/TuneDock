...
TuneDock – Remote for Spotify

## Résumé court

Contrôlez Spotify Web depuis le panneau latéral ou un widget flottant facultatif.

## Description

TuneDock garde les commandes de Spotify Web à portée de main pendant votre navigation.

Fonctions principales :

- lecture, pause, morceau précédent et suivant ;
- pochette, titre, artiste et progression ;
- volume, lecture aléatoire et répétition ;
- ajout et retrait des Titres likés ;
...
## Déclarations de confidentialité proposées

- Ne vend pas de données.
- N'utilise pas les données à des fins publicitaires.
- Ne collecte pas l'historique de navigation.
- Ne collecte pas d'informations d'authentification.
- Traite localement les informations musicales visibles nécessaires à la fonction.

## URLs

- Site / code source : https://github.com/SDINAHET/TuneDock
- Support : https://github.com/SDINAHET/TuneDock/issues
- Confidentialité : https://github.com/SDINAHET/TuneDock/blob/main/PRIVACY.md
